...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps
                .Where(emp => emp.Salary == Emps.Max(tmpEmp => tmpEmp.Salary));
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Depts
                .GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emps) =>
                    new
                    {
                        name = dept.Dname,
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emps) => new
                    {
                        dept = dept,
                        numOfEmps = emps.Count()
                    }
                ).Where(r => r.numOfEmps == 0 || r.numOfEmps == 5)
                .Select(r => r.dept)
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps
                .Where(mgr => emps.Any(emp => emp.Mgr?.Empno == mgr.Empno))
